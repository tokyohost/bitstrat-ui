  ...
  <div>
    ...
    <el-popover placement="bottom-end" trigger="click" width="300">
      ...
      <div class="exchange-list">
        <p style="margin-top: 0">{{ proxy.$t('navbar.notifySetting') }}</p>
...
import { Notification, Setting } from '@element-plus/icons-vue';
...
import { getNotifySettingStatus } from '@/layout/components/NotifySetting/notifySetting';
...
const loadApiSetting = async () => {
  const axiosResponse = await getNotifySettingStatus();
