export default {
  ...
  aiTask: {
    ...
    middleTermIndicator: '中期指标',
    needMiddleTerm: '是否需要中期指标',
    middleTermIndicatorPopoverTitle: '中期指标',
    middleTermIndicatorPopoverContent: '每次调用AI时获取多长时间的K线数据作为中期指标EMA/MACD/RSI 等的数据源',
    ...
    rule: {
      ...
      needMiddleTerm: '请选择是否需要中期指标',
      middleTermInterval: '中期周期必须大于短周期并且小于长期周期',
