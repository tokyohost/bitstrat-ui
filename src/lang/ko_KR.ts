export default {
  ...
  "agreement": {
    ...
    "intro": "본 플랫폼(이하 “플랫폼”) 이용을 환영합니다. 플랫폼이 제공하는 AI 기술 서비스를 이용하기 전에 본 면책 조항을 주의 깊게 읽고 충분히 이해해야 합니다. 플랫폼을 계속 이용하거나 API Key를 제출하는 경우, 귀하는 다음 내용에 대해 인지하고 전적으로 동의함을 의미합니다:",
    "section_1_title": "1. 플랫폼의 성격",
    "section_1_content": "플랫폼은 AI 모델 호출 및 프롬프트 실행 기능, API Key 관리 도구, 전략 생성 및 자동 실행 인터페이스만 제공합니다. 플랫폼은 투자 조언, 재무 서비스 또는 자산 관리 업무를 제공하지 않으며, 고객을 대신하여 운영하지도 않습니다.",
    "section_2_title": "2. 사용자 API Key 권한",
    "section_2_content": "사용자가 플랫폼에서 사용하는 모든 가상화폐 거래소 API Key는 사용자가 직접 생성, 승인, 관리합니다. API Key의 권한, 위험, 자율적인 통제권은 전적으로 사용자가 부담합니다. 플랫폼은 사용자 API Key를 저장하거나 유출하거나 오용하지 않지만, 사용자는 API Key가 합리적인 권한 범위(예: 거래 전용 권한, 출금 권한 없음)를 가지고 있는지 직접 확인해야 합니다.",
    "section_3_title": "3. AI 행동 및 결과",
    "section_3_content": "사용자는 직접 프롬프트(Prompt)를 작성하며, 플랫폼의 AI 엔진이 프롬프트에 따라 거래 API 요청을 실행합니다. AI가 실행하는 모든 행동, 거래, 주문 체결, 취소, 포지션 조정 등의 작업은 사용자가 자발적으로 시작한 것으로 간주됩니다. 플랫폼은 AI의 이해 편차, 판단 오류, 통신 이상, 거래 실패, 지연으로 인한 손실에 대해 책임을 지지 않습니다.",
    "section_4_title": "4. 거래 위험 경고",
    "section_4_content": "디지털 자산 거래에는 가격의 급격한 변동, 시스템 이상, API 실패, 전략 무효화, 시장 위험 등 높은 위험이 수반됩니다. AI를 사용하여 자동 거래를 수행하는 경우, 모델 출력 편차, 전략 논리 오류, 프롬프트 모호성, 시스템 식별 오류를 포함하여 예측할 수 없는 추가적인 위험이 존재합니다. 위에 언급된 어떠한 이유로든 발생하는 계정 자산 손실, 수익 감소, 주문 오류, 포지션 강제 청산 등은 전적으로 사용자가 부담합니다.",
    "section_5_title": "5. 수수료 약관",
    "section_5_content": "플랫폼은 AI 토큰 사용량에 따라 수수료를 부과하며, 이는 사용자의 거래 결과와 무관합니다. 플랫폼은 수익 분배에 참여하지 않으며, 거래 수수료를 부과하지 않고, 성장 기반의 수익이 없습니다. 사용자가 충전하거나 수수료가 발생한 후에도 플랫폼은 AI의 결과나 성능에 대해 어떠한 수익도 보장하지 않습니다.",
    "section_6_title": "6. 준수 및 사용 제한",
    "section_6_content": "사용자는 플랫폼을 이용하여 돈세탁, 현금 유용, 다크넷 거래 등을 포함한 어떠한 불법 활동도 수행할 수 없습니다. 사용자는 본 플랫폼 사용과 관련된 거래소 API, 전략, 행위가 현지 법률 및 규정을 준수하는지 확인해야 합니다. 법률 또는 규제 요구 사항을 위반하는 계정 운영은 전적으로 사용자가 책임을 부담합니다.",
    ...
    "section_8_content": "사용자는 자신의 거래에 대한 전적인 책임 부담, AI 모델의 출력 결과에 대한 독립적인 판단, 플랫폼 서비스를 투자 조언으로 간주하지 않음, API Key의 합법성 및 보안 보장, 모든 플랫폼 수수료 정책 및 호출 과금 규칙에 동의할 것을 약속합니다.",
