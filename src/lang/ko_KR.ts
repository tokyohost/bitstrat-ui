export default {
  ...
  aiTask: {
    ...
    preset3: '사전 설정된 프롬프트 3(KR)',
    presetWarning:
      '사전 설정된 프롬프트를 직접 사용하지 마십시오. 사전 설정된 프롬프트는 예제일 뿐입니다. 해당 형식을 따라 자신만의 고유한 거래 전략을 작성해야 합니다. (참고: 백테스팅 보고서에 따르면 사전 설정된 프롬프트는 90%의 시장 조건에서 성능이 좋지 않습니다.)',
    userPrompt: '사용자 프롬프트',
