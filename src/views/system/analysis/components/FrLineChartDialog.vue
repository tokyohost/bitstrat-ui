<template>
  <div class="flex justify-center items-center ml1">
    <el-dialog v-model="visible" title="资金费历史趋势" width="1000px" :destroy-on-close="true">
      <div v-if="loading" class="text-center p-4">加载中...</div>
      <FrLineChart v-else :frDataMap="chartData.frDataMap" :dateList="chartData.dateList" class="w-full" />
    </el-dialog>
