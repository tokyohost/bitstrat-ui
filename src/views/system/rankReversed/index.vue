<template>
  <div class="p-2">
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="rankReversedFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="币种" prop="symbol">
...
<script setup name="RankReversed" lang="ts">
import { listRankReversed, getRankReversed, delRankReversed, addRankReversed, updateRankReversed } from '@/api/system/rankReversed';
import { RankReversedVO, RankReversedQuery, RankReversedForm } from '@/api/system/rankReversed/types';
import { syncRank } from '@/api/system/rankReversed';

const { proxy } = getCurrentInstance() as ComponentInternalInstance;

const rankReversedList = ref<RankReversedVO[]>([]);
...
const initFormData: RankReversedForm = {
  id: undefined,
  symbol: undefined,
  score: undefined,
...
/** 提交按钮 */
const submitForm = () => {
  rankReversedFormRef.value?.validate(async (valid: boolean) => {
    if (valid) {
