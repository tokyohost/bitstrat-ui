<template>
  <div style="margin: 0px 10px 0px 10px">
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="滑点触发" name="first">
        <div class="p-2">
          ...
          <el-card shadow="never">
            <template #header>
              <el-row :gutter="10" class="mb8">
                <el-col :span="1.5">
                  <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['system:lossPoint:add']"> 新增 </el-button>
                </el-col>
                <el-col :span="1.5">
                  <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['system:lossPoint:edit']"
                    >修改
                  </el-button>
                </el-col>
                <el-col :span="1.5">
                ...
                <el-col :span="1.5">
                  <el-button type="danger" plain icon="RefreshLeft" @click="syncAll()" v-hasPermi="['system:lossPoint:edit']">全量同步 </el-button>
                </el-col>
                <el-col :span="1.5">
                  <el-button type="danger" plain icon="Delete" @click="syncDeleteAll()" v-hasPermi="['system:lossPoint:edit']">全部移除 </el-button>
                </el-col>
            ...
            <el-table v-loading="loading" :data="lossPointList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="开仓止损比例" align="center" prop="triggerPrice2" />
              <el-table-column label="止损计算起点" align="center" prop="stopLossCalcLimit" />
              ...
              <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                  ...
                  <el-tooltip content="修改" placement="top">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:lossPoint:edit']"></el-button>
                  </el-tooltip>
          ...
          <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
            <el-form ref="lossPointFormRef" :model="form" :rules="rules" label-width="80px" :label-position="'top'">
              ...
              <el-form-item label="止损计算起点(上涨/下跌多少开始移动止损线)" prop="stopLossCalcLimit">
                <el-input v-model="form.stopLossCalcLimit" placeholder="请输入止损计算起点" />
              </el-form-item>
            </el-form>
            <template #footer>
...
import { getSupportExchange, listBybitSupportSymbols, queryExchangeStatus, queryNodeStatus, setLeverageBody } from '@/api/system/common/common';
...
const data = reactive<PageData<LossPointForm, LossPointQuery>>({
  ...
  rules: {
    ...
    stopLossCalcLimit: [{ required: true, message: '止损计算起点不能为空', trigger: 'blur' }]
  }
});
...
/** 复制操作 */
const handleCopy = async (row?: LossPointVO) => {
  reset();

  const res = await getLossPoint(row.id);
...
const handleDelete = async (row?: LossPointVO) => {
  ...
  await proxy?.$modal.confirm('是否确认删除滑点"' + row.price + '"的数据项？').finally(() => (loading.value = false));
