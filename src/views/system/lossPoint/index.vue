  ...
  <div class="p-2">
        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            <el-form-item label="交易所名称" prop="exchangeName">
              <el-input v-model="queryParams.exchangeName" placeholder="请输入交易所名称" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            ...
            <el-form-item label="下单数量" prop="quantity">
              <el-input v-model="queryParams.quantity" placeholder="请输入下单数量" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item>
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()" v-hasPermi="['system:lossPoint:remove']"
              >删除
            </el-button>
          </el-col>
          <el-col :span="1.5">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:lossPoint:remove']"></el-button>
            </el-tooltip>
            <el-tooltip content="同步" placement="top">
              <el-button link type="primary" icon="RefreshLeft" @click="handleSync(scope.row)" v-hasPermi="['system:lossPoint:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="从节点移除" placement="top">
              <el-button link type="primary" icon="RemoveFilled" @click="handleStop(scope.row)" v-hasPermi="['system:lossPoint:edit']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="lossPointFormRef" :model="form" :rules="rules" label-width="80px" :label-position="'top'">
        ...
        <el-form-item label="下单+-" prop="triggerPrice1">
          <el-input v-model="form.triggerPrice1" placeholder="请输入下单+-" />
        </el-form-item>
        <!--        <el-form-item label="触发价2" prop="triggerPrice2">-->
        <!--          <el-input v-model="form.triggerPrice2" placeholder="请输入触发价2" />-->
        <!--        </el-form-item>-->
        <el-form-item label="回撤率" prop="retread">
