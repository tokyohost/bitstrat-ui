    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['system:crossExchangeArbitrageTask:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['system:crossExchangeArbitrageTask:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()" v-hasPermi="['system:crossExchangeArbitrageTask:remove']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['system:crossExchangeArbitrageTask:export']">导出</el-button>
          </el-col>
      ...
      <el-table v-loading="loading" :data="crossExchangeArbitrageTaskList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="做多交易所" align="center" prop="longEx" />
        <el-table-column label="做多币对" align="center" prop="longSymbol" />
        <el-table-column label="做多金额 USDT" align="center" prop="longSize" />
        <el-table-column label="做多持仓数量" align="center" prop="longSymbolSize" />
        <el-table-column label="做多入场价" align="center" prop="longAvgPrice" />
        <el-table-column label="做多出场价" align="center" prop="longOutPrice" />
        <el-table-column label="做多盈亏 USDT" align="center" prop="longProfit" />
        <el-table-column label="做多入场时间" align="center" prop="longInTime" width="180">
          <template #default="scope">
            <span>{{ parseTime(scope.row.longInTime, '{y}-{m}-{d}') }}</span>
          </template>
        </el-table-column>
        <el-table-column label="做多杠杆倍数" align="center" prop="longLeverage" />
        <el-table-column label="做多开仓手续费" align="center" prop="longInFee" />
        <el-table-column label="做多平仓手续费" align="center" prop="longOutFee" />
        <el-table-column label="做空交易所" align="center" prop="shortEx" />
        <el-table-column label="做空币对" align="center" prop="shortSymbol" />
        <el-table-column label="做空金额 USDT" align="center" prop="shortSize" />
        <el-table-column label="做空持仓数量" align="center" prop="shortSymbolSize" />
        <el-table-column label="做空入场价" align="center" prop="shortAvgPrice" />
        <el-table-column label="做空出场价" align="center" prop="shortOutPrice" />
        <el-table-column label="做空盈亏 USDT" align="center" prop="shortProfit" />
        <el-table-column label="做空入场时间" align="center" prop="shortInTime" width="180">
          <template #default="scope">
            <span>{{ parseTime(scope.row.shortInTime, '{y}-{m}-{d}') }}</span>
          </template>
        </el-table-column>
        <el-table-column label="做空杠杆倍数" align="center" prop="shortLeverage" />
        <el-table-column label="做空开仓手续费" align="center" prop="shortInFee" />
        <el-table-column label="做空平仓手续费" align="center" prop="shortOutFee" />
        <el-table-column label="执行节点clientId" align="center" prop="excuteNodeId" />
        <el-table-column label="总盈亏 USDT" align="center" prop="totalProfit" />
        <el-table-column label="状态 1-正在运行 2-已停止 3-未启动" align="center" prop="status" />
        <el-table-column label="用户id" align="center" prop="userId" />
        <el-table-column label="任务开始时间戳" align="center" prop="startTime" />
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:crossExchangeArbitrageTask:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:crossExchangeArbitrageTask:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
