    ...
    <el-card class="w-full" shadow="hover">
      <div class="flex flex-row ">
        <div class="flex justify-between w-full">
          <div class="flex justify-start text-center align--center ml-2 gap-col-1">
            <TradePairTag :direction="props.position.side" :symbol="props.position.symbol"
                          :exchange="props.position.exchange" :diy-ex-logo="true" :exchange-logo="'default'"></TradePairTag>
      ...
      <div class="flex flex-row  w-full">
        <div class="flex flex-1 text-xs">
          ...
          <div class="border-b-unset ml-1 color-blue">{{ props.position.size ?? '-' }}</div>
        </div>
        <div class="flex flex-1 text-xs">
